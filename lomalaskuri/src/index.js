...
let themes = {
	NoykkionKoulu: [
		{ nimi: "--menu-color", light: "transparent", dark: "#1616160" },
		{ nimi: "--places-color", light: "white", dark: "#1616160" },
		{ nimi: "--border-color", light: "#ddd", dark: "black" },
		{ nimi: "--text-color", light: "black", dark: "white" },
		{ nimi: "--invert-amount", light: "0%", dark: "100%" },
		{ nimi: "--mobile-menu-color", light: "white", dark: "#161616" },
		{
			nimi: "--quick-color",
		...
		{ nimi: "--background-color", light: "#a9d3ff", dark: "#161616" },
		{ nimi: "--shadow-color", light: "rgba(0,0,0,0.5)", dark: "rgba(0,0,0,1)" },
		{ nimi: "--logo-color", light: "#4389f9", dark: "#161616" },
	],
	HaukilahdenKoulu: [
		{ nimi: "--menu-color", light: "transparent", dark: "#161616" },
		{ nimi: "--places-color", light: "white", dark: "#161616" },
		{ nimi: "--border-color", light: "#ddd", dark: "black" },
		{ nimi: "--text-color", light: "black", dark: "white" },
		{ nimi: "--invert-amount", light: "0%", dark: "100%" },
		{ nimi: "--mobile-menu-color", light: "white", dark: "#161616" },
