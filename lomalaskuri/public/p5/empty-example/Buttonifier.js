...
function createInnerButton(X, Y, Height, Width,Msg, Style, PositionPoint, Action) {
	var charString;
		...
		case 'default': //tai default joka on vasen yläkulma
			switch(Style) {
				...
				case 'default':
					...
					text(Msg, X+Width/2, (Y+Height/2)-(textDescent() + textAscent())/2);
				break;
...
function createImageButton(X, Y, Height, Width,Msg,Img, PositionPoint, Action) {
	var currentBtn;
