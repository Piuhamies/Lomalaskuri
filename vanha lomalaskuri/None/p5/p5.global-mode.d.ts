 ...
 */
declare function bezierTangent(
  a: number,
  b: number,
  c: number,
  d: number,
 ...
 */
declare function createGraphics(
  w: number,
  h: number,
  renderer?: RENDERER
): p5.Graphics;
 ...
 *   @chainable
 */
declare function quadraticVertex(
  cx: number,
  cy: number,
  x3: number,
  y3: number
 ...
 */
declare function loadXML(
  filename: string,
  callback?: Function,
  errorCallback?: Function
): object;
declare function loadBytes(
  file: string,
  callback?: Function,
  errorCallback?: Function
): object;
 ...
 *   @chainable
 */
declare function ambientMaterial(
  v1: number,
  v2?: number,
  v3?: number,
  a?: number
 ...
 *   @chainable
 */
declare function specularMaterial(
  v1: number,
  v2?: number,
  v3?: number,
  a?: number
 ...
 */
declare function createCapture(
...
// Constants
type COLOR_MODE = typeof RGB | typeof HSB | typeof HSL;

type ARC_MODE = typeof CHORD | typeof PIE | typeof OPEN;
...
type RECT_MODE = typeof CORNER | typeof CORNERS | typeof CENTER | typeof RADIUS;

type STROKE_CAP = typeof SQUARE | typeof PROJECT | typeof ROUND;

type STROKE_JOIN = typeof MITER | typeof BEVEL | typeof ROUND;

type RENDERER = typeof P2D | typeof WEBGL;
...
type END_MODE = typeof CLOSE;

type IMAGE_MODE = typeof CORNER | typeof CORNERS | typeof CENTER;
...
type ANGLE_MODE = typeof RADIANS | typeof DEGREES;

type HORIZ_ALIGN = typeof LEFT | typeof CENTER | typeof RIGHT;

type VERT_ALIGN = typeof TOP | typeof BOTTOM | typeof CENTER | typeof BASELINE;

type THE_STYLE = typeof NORMAL | typeof ITALIC | typeof BOLD;
