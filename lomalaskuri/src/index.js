...
let themes = {
  NoykkionKoulu: [{ nimi: "--menu-color", light: "transparent", dark: "#0f0f0f0" },
  ...
  HaukilahdenKoulu: [{ nimi: "--menu-color", light: "transparent", dark: "#0f0f0f" },
  ...
  LaurinlahdenKoulu: [{ nimi: "--menu-color", light: "transparent", dark: "#0f0f0f" },
  { nimi: "--places-color", light: "white", dark: "#0f0f0f" },
  { nimi: "--border-color", light: "#ddd", dark: "black" },
  { nimi: "--text-color", light: "black", dark: "white" },
  { nimi: "--invert-amount", light: "0%", dark: "100%" },
  ...
  VanttilanKoulu: [{ nimi: "--menu-color", light: "transparent", dark: "#0f0f0f" },
  { nimi: "--places-color", light: "white", dark: "#0f0f0f" },
  { nimi: "--border-color", light: "#ddd", dark: "black" },
  { nimi: "--text-color", light: "black", dark: "white" },
  { nimi: "--invert-amount", light: "0%", dark: "100%" },
  ...
  OtaniemenLukio: [{ nimi: "--menu-color", light: "transparent", dark: "#0f0f0f" },
  { nimi: "--places-color", light: "white", dark: "#0f0f0f" },
  { nimi: "--border-color", light: "#ddd", dark: "black" },
  { nimi: "--text-color", light: "black", dark: "white" },
  { nimi: "--invert-amount", light: "0%", dark: "100%" },
  ...
  login: [{ nimi: "--menu-color", light: "transparent", dark: "#0f0f0f" },
  { nimi: "--places-color", light: "white", dark: "#0f0f0f" },
  { nimi: "--border-color", light: "#ddd", dark: "black" },
  { nimi: "--text-color", light: "black", dark: "white" },
  { nimi: "--invert-amount", light: "0%", dark: "100%" },
  { nimi: "--mobile-menu-color", light: "white", dark: "#202020" },
  { nimi: "--background-image", light: "var(--light-bg-img)", dark: "var(--dark-bg-img)" },
  { nimi: "--bg-fallback-image", light: "var(--light-bg-img-fallback)", dark: "var( --light-bg-img-fallback)" },
  ...
  { nimi: "--quick-invert-color", light: "rgba(0,0,0,0.5)", dark: "rgba(255,255,255,0.1)" },
  { nimi: "--seperator-color", light: "#4389f9", dark: "#4389f9" },
  { nimi: "--login-bg", light: "var(--login-gradient-white)", dark: "var(--login-gradient)", },
  { nimi: "--header-color", light: "black", dark: "rgb(223, 239, 255)", },
  { nimi: "--background-color", light: "#a9d3ff", dark: "#0f0f0f", },
  { nimi: "--shadow-color", light:"rgba(0,0,0,0.5)", dark: "rgba(0,0,0,1)"},
  ]
...
let allSchools = [
  ...
  },
  {
    ...
    href: "OtaniemenLukio",
    menuItems: [
      { nimi: "Etusivu", 'class': <QuickFront quickItems={[<QuickLaskuri key="QuickLaskuri" href="Laskuri" />, <QuickRuokalista key="QuickRuoka" url="https://lomalaskuribackend.herokuapp.com/otaniemiData"  href="Ruokalista" />, <QuickForm key="QuickPalaute" kysymys="Anna palautetta: " teksti="Mitä pidit Espoon lomalaskurista?" href="Palaute" />, <QuickSettings key="QuickSettings" theme={themes.OtaniemenLukio} themes={toggleTheme} />]} /> },
      { nimi: "Laskuri", 'class': <TimerClass /> },
      { nimi: "Ruokalista", 'class': <RuokalistaSivu url="https://lomalaskuribackend.herokuapp.com/otaniemiData" /> },
      { nimi: "Palaute", 'class': <Kysely src="https://docs.google.com/forms/d/e/1FAIpQLScDKaDx8NfuXFqhVJYBhdimrqr2AoAbsCFEroy8W0EcFD8ABQ/viewform?embedded=true" /> }
    ],
    ...
    menuItems: [
      ...
      { nimi: "Etusivu", 'class': <QuickFront quickItems={[<QuickLaskuri key="QuickLaskuri" href="Laskuri" />, <QuickRuokalista key="QuickRuoka" url="https://lomalaskuribackend.herokuapp.com/aromidata"  href="Ruokalista" />, <QuickForm key="QuickForm" kysymys="Vastaa kyselyyn:" teksti="Mikä on eniten käyttämäsi ominaisuus lomalaskurissa?" href="Kysely" />, /*<QuickGallery href="Galleria" />,*/ <QuickForm key="QuickPalaute" kysymys="Anna palautetta: " teksti="Mitä pidit Espoon lomalaskurista?" href="Palaute" />, <QuickTilastot key="quickTilastot" href="Tilastot" tiedot={{ positive: ["Onko koulussa jonneja", "Onko kahvikone saapunut"], negative: ["Onko Kahvila avattu"] }} />, <QuickSettings key="QuickSettings" theme={themes.JuvanPuisto} themes={toggleTheme} />]} /> },
      { nimi: "Laskuri", 'class': <TimerClass /> },
      //{ nimi: "Chat", 'class': <Chat />},
      { nimi: "Ruokalista", 'class': <RuokalistaSivu url="https://lomalaskuribackend.herokuapp.com/aromidata"/> },
      { nimi: "Kysely", 'class': <Kysely src="https://docs.google.com/forms/d/e/1FAIpQLSfj_JGrXaJ2qEMmXcaLw7ymbE9SO2-gqT9I5vSC-mN4KC5Hdw/viewform?embedded=true" /> },
      //{ nimi: "Galleria", 'class': <Galleria /> },
      // { nimi: "Pelit", 'class': <Pelit /> },
      { nimi: "Tilastot", 'class': <Tilastot tiedot={{ positive: ["Onko koulussa jonneja", "Onko kahvikone saapunut"], negative: ["Onko Kahvila avattu"] }} /> },
      { nimi: "Palaute", 'class': <Kysely src="https://docs.google.com/forms/d/e/1FAIpQLScDKaDx8NfuXFqhVJYBhdimrqr2AoAbsCFEroy8W0EcFD8ABQ/viewform?embedded=true" /> },
    ],
