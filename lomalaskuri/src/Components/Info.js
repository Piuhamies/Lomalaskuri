...
export function Info(props) {
    ...
    return (
        <div className="infoPage">
                ...
                <div className={`cubeSide cubeSide2`}>
                    ...
                    <div>
                        <div className="infoText">
                            ...
                            <p>Luonut / Kehittäjä: <span className="highlight">Severi Lybeck</span></p>
                            <p>Mukana ylläpidossa:<span className="highlight"> Avery</span></p>
                        </div>
            ...
            />
            <button className="backArrow linkLookALike" onClick={goBack}><img alt="close" src={arrow}></img>
            </button>
        </div>
    );
}
