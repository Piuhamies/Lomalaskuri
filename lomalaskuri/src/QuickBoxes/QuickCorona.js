...
export default class QuickCorona extends React.Component {
    ...
    componentDidMount() {
        ...
        var timers = [
            { nimi: "Aikaa koulujen sulkemiseen", start: new Date("Mar 1, 2021 00:00:00"), end: new Date("April 11, 2021 10:00:00") }
        ...
        let updateElems = (distance, oldDistance) => {
            ...
            if (timers[0].start.getTime() < nyt) {
                stateToBeSet.otsikko = (<h2 className="alaotsikot corona">Aikaa lähiopetuksen jatkumiseen:</h2>);
            }
            else {
